...
for J = 3, 22, 1 do
    if type(READ_VALUES00010[WRITE_I00011]) == "string" and #READ_VALUES00010[WRITE_I00011] == 0 then READ_VALUES00010[
        WRITE_I00011] = " " end
...
WRITE_I00015 = WRITE_I00015 + 1
for L = 1, 10, 1 do
    if type(READ_VALUES00014[WRITE_I00015]) == "string" and #READ_VALUES00014[WRITE_I00015] == 0 then READ_VALUES00014[
        WRITE_I00015] = " " end
