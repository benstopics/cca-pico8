C ADVENTURES
     ...
     COMMON RTEXT,LLINE
     SETUP=0
     DIMENSION IOBJ(1000),ICHAIN(1000),IPLACE(1000)
     1 ,IFIXED(1000),COND(1000),PROP(1000),ABB(1000),LLINE(1000,22)
     2 ,LTEXT(1000),STEXT(1000),KEY(1000),DEFAULT(1000),TRAVEL(1000)
     3 ,TK(1000),KTAB(1000),ATAB(1000),BTEXT(1000),DSEEN(1000)
     4 ,DLOC(1000),ODLOC(1000),DTRAV(1000),RTEXT(1000),JSPKT(1000)
     5 ,IPLT(1000),IFIXT(1000)
